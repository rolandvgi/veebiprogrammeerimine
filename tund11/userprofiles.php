...
$mybgcolor = "#FFFFFF";
$mytxtcolor = "#000000";
$aprofilePic ="../vp_picfiles/vp_user_generic.png";
$addedPhotoId = null;
...
?>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"method="post" enctype="multipart/form-data">
	  ...
	  <input name="submitProfile" type="submit" value="Salvesta profiil"><?php echo $notice; ?>
		...
		<input type="file" name="submitProfile" id="fileToUpload"><br>
		<img src="<?php echo $profilePic ?>" alt=<?php echo $_SESSION["firstName"] ." " .$_SESSION["lastName"];
	  ?> height="300px" width="300px" /><br/><br />
